<?php //{
  ...
  "STORAGE::EXTERNAL::GDRIVE": "false",
  "STORAGE::EXTERNAL::GDRIVE::DIRNAME": "BACKUP_MIGRATION_BACKUPS",
  ...
  "BACKUP:FILES::FILTER": "true",
  "BACKUP:FILES::FILTER:SIZE": "true",
  ...
  "BACKUP:FILES::FILTER:NAMES:IN": [
    ...
    {"txt": ".part",           "pos": "3", "whr": "1" },
    {"txt": ".tmp",            "pos": "3", "whr": "1" },
    {"txt": ".zip",            "pos": "3", "whr": "1" },
    {"txt": ".tr",             "pos": "3", "whr": "1" },
    {"txt": ".gz",             "pos": "3", "whr": "1" },
    {"txt": ".sgbp",             "pos": "3", "whr": "1" }
  ],
  ...
  "OTHER:EXPERIMENT:TIMEOUT": false,
  "OTHER:EXPERIMENT:TIMEOUT:HARD": false,
  ...
  "OTHER:CLI:PATH": "",
  "OTHER:DB:QUERIES": "500",
  "OTHER:DB:SEARCHREPLACE:MAX": "50",
  "OTHER:FILE:EXTRACT:MAX": "auto",
